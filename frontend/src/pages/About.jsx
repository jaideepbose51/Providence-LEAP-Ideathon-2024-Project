  ...
  return (
    <div>
      <div className='text-center text-2xl pt-10 text-gray-500'>
        <p><span className='text-gray-700 font-medium'>ABOUT </span>US</p>
      </div>

      <div className='my-10 flex flex-col md:flex-row gap-12'>
        <img className='w-full md:max-w-[360px]' src={assets.about_image} alt="" />
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
          <p>Welcome to Prescripto. Your trusted partner in managing your healthcare needs conventiently and efficiently at Prescripto.we understand the challanges individuals face when it comes to scheduling doctor appointment and managing their health record.</p>
